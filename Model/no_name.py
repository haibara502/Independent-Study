...
TEXT_INPUT_FILE = '../Dataset/Supreme_Court/supreme_input_temp.txt'
...
script_output = TimeDistributed(Bidirectional(LSTM(NUM_HIDDEN, return_sequences=True), merge_mode='concat'))(script_input)
...
#name_output = Embedding(input_length = NUMBER_OF_UTTERANCE, input_dim = NUMBER_OF_NAMES, output_dim=NAME_EMBEDDING_SIZE)(name_input)

#name_output = TimeDistributed(Dense(EMBEDDING_DIM))(name_input)
...
output = LSTM(NUMBER_OF_UTTERANCE)(script_output)
